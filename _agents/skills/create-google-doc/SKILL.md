...
Ensure your Cloudtop virtual workstation host is present in `/Users/shacharb/Downloads/ce-scale/gcp_config.txt`:
```text
...
```bash
python3 _agents/skills/create-google-doc/scripts/create_doc.py --src "artifacts/blueprint.md" --title "Artifact Blueprint: Customer Name"
```
...
```python
import sys
sys.path.append('/Users/shacharb/Downloads/ce-scale/_agents/skills/create-google-doc/scripts')
