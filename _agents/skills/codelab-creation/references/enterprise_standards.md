...
*   **Examples**:
    *   *Instead of*: "How to configure SNI routing."
    *   *Use*: "How a SaaS provider can route hundreds of customer vanity domains through a single load balancer without managing their SSL certificates."
...
*   **Pattern**: Security validation must prove what *cannot* happen as much as what *can*.
