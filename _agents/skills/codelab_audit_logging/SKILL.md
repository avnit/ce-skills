...
```bash
./_agents/skills/codelab_audit_logging/scripts/gather_evidence.py {project_id} {output_file}
```

Example:
```bash
./_agents/skills/codelab_audit_logging/scripts/gather_evidence.py gke-service-ext-1775761721 ./evidence.md
```
