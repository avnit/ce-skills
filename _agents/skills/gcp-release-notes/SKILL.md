...
```bash
python3 _agents/skills/gcp-release-notes/scripts/get_release_notes.py --topic "YOUR_TOPIC" [options]
```
...
Running:
```bash
python3 _agents/skills/gcp-release-notes/scripts/get_release_notes.py --topic "session affinity" --limit 1
```
Yields:
...
Running:
```bash
python3 _agents/skills/gcp-release-notes/scripts/get_release_notes.py --topic "Cloud NGFW" --limit 1 --ai-explain
```
Yields:
## Google Cloud Release Notes: Search Results
