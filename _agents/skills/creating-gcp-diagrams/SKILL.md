...
2. **Mandatory**: Copy the generated image from the artifacts directory to the source lab's folder (e.g., `_agents/skills/codelab-creation/examples/<lab-name>/`). If an `img/` subdirectory is preferred, create it there.
