...
You need a `gcp_config.txt` file in your working directory or in the script directory.
...
```bash
python3 _agents/skills/gcp-provisioning/scripts/create_project.py <lab_name> [round_number]
```
