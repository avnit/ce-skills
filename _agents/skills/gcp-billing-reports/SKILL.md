...
```bash
python3 _agents/skills/gcp-billing-reports/scripts/get_billing_reports.py [options]
```
...
```bash
python3 _agents/skills/codelab-cleanup/scripts/cleanup_projects.py --delete infra-host-project-464423 --force
```
