...
def check_gcp_config():
    path = "/Users/shacharb/Downloads/ce-scale/gcp_config.txt"
...
def check_mcp_servers():
    config_path = "/Users/shacharb/Downloads/ce-scale/.gemini/mcp_config.json"
    ...
    for name, cfg in mcp_servers.items():
        ...
        user_project = cfg.get("headers", {}).get("X-goog-user-project")
        if user_project:
...
def generate_markdown_report(gcp_ok, gcp_msg, mcp_ok, mcp_results, report_path=None):
    ...
    if all_pass:
        ...
        html.append('<a href="https://docs.google.com/document/d/1RLhTRPgfZnXssXog-pKbBnMExulxZyaKMWWTbtw0mF0/edit?usp=sharing&resourcekey=0-ETB7RzJbpqeYH2syDTMF4g">CE-Scale JetSki Configuration</a>.')
        html.append('</p>')
    else:
        html.append('<p style="margin: 0; font-size: 14px; color: #5f6368; line-height: 1.5;">')
