...
```bash
python3 _agents/skills/codelab-memory/scripts/query_rag.py --query "your search topic"
```
...
```bash
python3 _agents/skills/codelab-memory/scripts/query_rag.py --learn --problem "Description of problem" --solution "Description of solution" --context "Topic/Service"
```
