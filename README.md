...
| :------------------------------------------------------------------------------------------------------ | :-------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| [agent-waf-system/](.agents/skills/agent-waf-system/SKILL.md)                                           | WAF ADR Engine              | Orchestrates interactive multi-agent discovery, constraint checks, and automated CISO gating for WAF designs.      |
| [alts-brief/](.agents/skills/alts-brief/SKILL.md)                                                       | Alternative Investments     | Prepares meeting-ready alternative-investments brief covering NAV, commitments, and liquidity.                     |
...
| [compliance/](.agents/skills/compliance/SKILL.md)                                                       | SEC Compliance Review       | Reviews client-facing communications against SEC rules (Marketing Rule, Fiduciary Duty).                           |
...
| [estate-and-tax-brief/](.agents/skills/estate-and-tax-brief/SKILL.md)                                   | Estate & Tax Briefing       | Cross-checks estate plans against custodial titling and beneficiary registrations.                                 |
...
| [fin-advisors-onboarding/](.agents/skills/fin-advisors-onboarding/SKILL.md)                            | Financial Advisors Setup    | Specialization onboarding for wealth management and financial advisory practices.                                  |
...
| [gcp-architecture-compliance/](.agents/skills/gcp-architecture-compliance/SKILL.md)                     | Regulatory Architecture QA  | Audits GCP architectures against HIPAA, PCI DSS, FedRAMP, SOC 2, and ISO 27001 boundaries.                         |
...
| [gcp-dod-compliance/](.agents/skills/gcp-dod-compliance/SKILL.md)                                       | DoD SRG Review (IL2/IL4/IL5)| Audits defense workloads for DoD CC SRG (IL2, IL4, IL5), DISA CAP, and Assured Workloads.                          |
| [gcp-fedramp-compliance/](.agents/skills/gcp-fedramp-compliance/SKILL.md)                               | FedRAMP High/Mod Review     | Audits federal architectures against FedRAMP High/Moderate and NIST SP 800-53 controls.                            |
| [gcp-hipaa-compliance/](.agents/skills/gcp-hipaa-compliance/SKILL.md)                                   | HIPAA Healthcare Review     | Validates Google Cloud BAA eligibility, Data Access audit logs, and § 164.312 safeguards.                          |
| [gcp-pci-compliance/](.agents/skills/gcp-pci-compliance/SKILL.md)                                       | PCI DSS 4.0 Payment Review  | Audits Cardholder Data Environments (CDE), tokenization, Cloud Armor WAF, and Level 1 AoC.                          |
...
| [portfolio-rebalance-review/](.agents/skills/portfolio-rebalance-review/SKILL.md)                       | Portfolio Drift Analysis    | Analyzes allocation drift vs. IPS targets and drafts tax-aware rebalancing memos.                                  |
| [post-meeting/](.agents/skills/post-meeting/SKILL.md)                                                   | Client Follow-up Automation | Synthesizes meeting transcripts into CRM action items, opportunities, and follow-ups.                               |
| [pre-meeting/](.agents/skills/pre-meeting/SKILL.md)                                                     | Client Meeting Preparation  | Assembles meeting prep dossiers across CRM, portfolio systems, and recent correspondence.                         |
| [prospect-intake/](.agents/skills/prospect-intake/SKILL.md)                                             | Prospect Intake & Handoff   | Structures discovery intake notes into prospect summaries and analyst handoff memos.                               |
