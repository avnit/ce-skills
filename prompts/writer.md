...
- **Defensive Scripting and Edge-Case Handling**: Anticipate friction. Add notes about propagation delays (e.g., _"Wait 2-3 minutes for health checks to pass"_).
...
- **The "Why"**: Start with a compelling explanation of the problem this codelab solves. Use real-world context (e.g., enterprise challenges, scale issues) to explain _why_ the reader should care about this feature or architecture.
...
2.  **Draft Content**:
    - **Hands-on First**: Make it clear immediately what the user will _do_.
