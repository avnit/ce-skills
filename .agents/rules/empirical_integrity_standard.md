...
- **No Bake-Ins:** You MUST explicitly explain in your walkthroughs and reports _why_ local test sandbox output differs empirically from enterprise production scale. Never bake enterprise production metrics or load assumptions into local verification code just to make output look "pretty" or "complete."
