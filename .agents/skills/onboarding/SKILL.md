...
4. **Piper CompanyDoc Readiness Check**: Verifies if an active CitC/Fig workspace under `${CITC_WORKSPACE_ROOT:-/google/src/cloud/$USER/<your-client>/google3}` includes the `/company` view.
