...
```bash
python3 .agents/skills/git-update/scripts/git_update.py -m "Your commit message"
```

To stage and commit only a specific file or directory:

```bash
python3 .agents/skills/git-update/scripts/git_update.py -m "Your commit message" --path path/to/file_or_directory
```
