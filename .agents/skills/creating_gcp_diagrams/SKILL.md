...
*   **Zone / Network Containers**: Select from standard Google theme colors:
    *   *Blue theme*: Google Blue 200 (`#AECBFA`) or Blue 300 (`#8AB4F8`).
    *   *Gray theme*: Google Gray 200 (`#E8EAED`) or Gray 300 (`#DADCE0`).
    *   *Yellow theme*: Google Yellow 100 (`#FEEFC3`) or Yellow 200 (`#FDE293`).
    *   *Green theme*: Google Green 100 (`#CEEAD6`) or Green 200 (`#A8DAB5`).
    *   *Red theme*: Google Red 100 (`#FAD2CF`) or Red 200 (`#F6AEA9`).
