#!/usr/bin/env python3
"""Canonical GoogleSQL query template and Buganizer component constants for Cloud Blocker & Customer Request analytics.
"""
        ...
        SELECT
          ...
          CASE
            ...
            WHEN
              (pnl_category_1 IS NOT NULL AND pnl_category_1 != '')
              AND (pnl_category_2 IS NULL OR pnl_category_2 = '')
              AND (pnl_category_3 IS NOT NOT NULL AND pnl_category_3 != '')
