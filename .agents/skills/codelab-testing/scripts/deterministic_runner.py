...
def normalize_command(cmd: str) -> str:
    """Normalizes a command string by stripping comments, double spaces, and whitespace to make hashing robust."""
    lines = []
...
def get_cmd_hash(cmd: str) -> str:
    """Computes SHA-256 hash of a normalized command string."""
