...
def try_agentapi_extraction(failed_cmd: str, error_msg: str, remediation: str) -> Optional[Dict[str, Any]]:
    ...
    This eliminates the need for end users to enable direct Vertex AI GCP project APIs or billing.
    """
...
def extract_generalized_lesson(bug_payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Priority 2: Try calling Vertex AI Gemini (if project API is configured and enabled)
    try:
        import vertexai
